...
.method public maybePollTimestamp(J)Z
    ...
    .line 111
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->maybePollTimestamp(JZ)Z
...
.method public maybePollTimestamp(JZ)Z
    .locals 6
    .annotation build Landroid/annotation/TargetApi;
        value = 0x13
    .end annotation
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller$AudioTimestampV19;->maybeUpdateTimestamp()Z
    ...
    .line 156
    iget-wide v2, p0, Lcom/google/android/exoplayer2/audio/AudioTimestampPoller;->initialTimestampPositionFrames:J
