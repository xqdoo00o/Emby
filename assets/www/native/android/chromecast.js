define(['appSettings', 'apphost', 'userSettings', 'events', 'playbackManager', 'globalize', 'connectionManager'], function (appSettings, appHost, userSettings, events, playbackManager, globalize, connectionManager) {
    ...
    function ChromecastPlayer() {
        ...
        function sendMessageInternal(message) {
            ...
            AndroidChromecast.sendMessage(json);
        ...
        self.playWithCommand = function (options, command) {
            ...
            var apiClient = options.items ? connectionManager.getApiClient(options.items[0]) : connectionManager.getApiClient(options.serverId);
        ...
        self.queue = function (options) {
            return self.playWithCommand(options, 'PlayLast');
        };

        self.queueNext = function (options) {
            return self.playWithCommand(options, 'PlayNext');
        };
        ...
        self.mute = function () {
            AndroidAppHost.setReceiverMuted(true);
        };

        self.unMute = function () {
            AndroidAppHost.setReceiverMuted(false);
        };
        ...
        self.toggleMute = function () {
            ...
            AndroidChromecast.toggleRecieverMuted();
        };
        ...
        self.getTargets = function () {
            ...
            return Promise.resolve(JSON.parse(AndroidChromecast.getDevices()).map(convertRouteToTarget));
        };
        ...
        self.volumeDown = function () {
            ...
            AndroidChromecast.receiverVolumeDown();
        };

        self.volumeUp = function () {

            AndroidChromecast.receiverVolumeUp();
        };
        ...
        self.setVolume = function (vol) {
            ...
            AndroidChromecast.setReceiverVolumeLevel(vol);
        };
        ...
        function startSession(target) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                AndroidChromecast.startSession(target.id);
            });
        }
        ...
        AndroidChromecast.refreshRoutes();
    }
